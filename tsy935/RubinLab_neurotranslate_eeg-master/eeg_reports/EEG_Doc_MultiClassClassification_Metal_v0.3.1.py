...
column_names = ['multiclass_label_seizure', 'multiclass_label_slowing', 
...
def main(column_names, lfs, save_dir):
    ...
    if clobber_lfs or (not os.path.exists(Ls_file)):
        ...
        for i, docs in enumerate([train_docs, dev_docs, test_docs]):
            split_Ls = []
            curr_Ls = create_label_matrix(lfs,docs)
    ...
    #         (0,7),(0,8),(0,9),(0,10),(0,10)] # seizure is parent of motor, hyperkinetic, clonic and tonic seizures
    ...
    label_model_file = os.path.join(save_dir, 'trained_label_model')
