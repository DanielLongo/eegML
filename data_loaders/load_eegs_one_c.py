...
if __name__ == "__main__":
	...
	dataset = EEGDataset("/mnt/data1/eegdbs/SEC-0.1/stanford/",  num_examples=200, num_channels=44, length=1004, csv_file=csv_file)
	...
	np.save("sample_from_csv", dataset[0].numpy())
